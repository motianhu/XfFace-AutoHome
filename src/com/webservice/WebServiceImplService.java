 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webservice.com/", wsdlLocation = "http://112.74.65.110:12000/carWeb/external/webService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://112.74.65.110:12000/carWeb/external/webService?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://webservice.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
